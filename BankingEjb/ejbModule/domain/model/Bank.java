...
public class Bank implements Serializable {
	...
	//On rajoute les deux comptes "caisse" et "banque" de chaque banque
	@OneToOne
	private Account compte_caisse;
	@OneToOne
	private Account compte_banque;

	public Account getCompte_caisse() {
		return compte_caisse;
	}

	public void setCompte_caisse(Account compte_caisse) {
